...
# Prepare your data
texts = [("open it clear use c2 throw flashbang", "breach with c2 use stun grenade"), ("make entry use c2 deploy flashbang", "arrest him"), ("make entry use c2 deploy flashbang", "breach with c2 use stun grenade"), ("open it clear use c2 throw flashbang", "make entry use c2 deploy flashbang")]
...
sentence_2 = "breach with c2 use stun grenade"
